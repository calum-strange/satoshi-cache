...
def download_monthly_premiumIndexKlines(
    trading_type,
    symbols,
    num_symbols,
    intervals,
    ...
    for symbol in symbols:
        print(
            "[{}/{}] - start download monthly {} premiumIndexKlines ".format(
...
def download_daily_premiumIndexKlines(
    trading_type,
    symbols,
    num_symbols,
    intervals,
    ...
    for symbol in symbols:
        print(
            "[{}/{}] - start download daily {} premiumIndexKlines ".format(
                current + 1, num_symbols, symbol
            )
        )
        for interval in intervals:
            for date in dates:
                ...
                if start_date <= current_date <= end_date:
                    path = get_path(
                        trading_type, "premiumIndexKlines", "daily", symbol, interval
                    )
